...
@Service
public class ObdSummarySendEmail {
	...
	public static final Logger Logger = LoggerFactory.getLogger(ObdSummarySendEmail.class);
		...
		try {
			...
			if (emailList.size() > 0) {
				...
				helper.setText("Hi Support Team," + "\n\n" + "\n\n"
						+ "We Could Not Receieved As Given Below Panel Summary. Please Insert Before 9:30 AM" + "\n\n"
